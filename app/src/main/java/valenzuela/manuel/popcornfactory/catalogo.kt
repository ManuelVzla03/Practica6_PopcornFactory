...
class catalogo : AppCompatActivity() {
    ...
    fun cargarPeliculas(){
        peliculas.add(Pelicula("Big hero 6", R.drawable.bighero, R.drawable.headerbighero, "When a devastating event befalls the city of San Fransokyo and catapults Hiro into the midst of danger, he turns to Baymax and his close friends adrenaline junkie Go Go Tomago, neatnik Wasabi, chemistry whiz Honey Lemon and fanboy Fred. Determined to uncover the mystery, Hiro transforms his friends into a band of high-tech heroes called &quot;Big Hero 6.&quot;"))
